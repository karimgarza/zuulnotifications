    ...
    public void customizeTomcat(TomcatEmbeddedServletContainerFactory factory) {
        factory.addConnectorCustomizers(new TomcatConnectorCustomizer() {
            ...
            public void customize(Connector connector) {
                ...
                Object defaultTimeout = connector.getAttribute("asyncTimeout");
                connector.setAttribute("maxThreads", MAX_THREADS);
                connector.setAttribute("asyncTimeout", 15000);
                LOG.info("Changed Tomcat connector maxThreads from " + defaultMaxThreads + " to " + MAX_THREADS);
                LOG.info("Changed Tomcat connector asyntTimeOut from " + defaultTimeout + " to 15000");
            }
        });
    }
}
